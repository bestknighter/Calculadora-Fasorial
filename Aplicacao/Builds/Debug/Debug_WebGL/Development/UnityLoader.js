...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'Debug_WebGL.data';
    var REMOTE_PACKAGE_BASE = 'Debug_WebGL.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 2984231;
      var PACKAGE_UUID = '419ff9eb-848f-4472-b08d-f8686cfa44e7';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 200370, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(200370, 201201, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(201201, 204314, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(204314, 2081634, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(2081634, 2956606, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(2956606, 2984231, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_Debug_WebGL.data');

    };
    Module['addRunDependency']('datafile_Debug_WebGL.data');
